package br.com.fiap.app009_formulario
...
class MainActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val checkBoxTelefone = findViewById<CheckBox>(R.id.checkBoxContato)
        val checkBoxEmail = findViewById<CheckBox>(R.id.checkBoxEmail)
        val buttonMostrarMensagem = findViewById<Button>(R.id.btCadastrar)

        // Configurar o adpter para o Spinner do Tipo de Telefone
